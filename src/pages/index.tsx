...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Restaurant booking engine v4`}</title>

        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine v4 - Streamlining your dining experience by simplifying table reservations and menu management for restaurants and their customers."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZXN0YXVyYW50fGVufDB8fHx8MTY5MjYxMjc5MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Restaurant booking engine v4`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine v4 - Streamlining your dining experience by simplifying table reservations and menu management for restaurants and their customers.`}
            </Text>
            <Box
